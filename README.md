...
```
При корректном завершении сборки в консоли выводится сообщение об успешности и получившиеся файлы задач в .xml формате (они находятся в директории dist).

## Внедрение задач в Moodle
Для добавления задач в курс на Moodle необходимо иметь роль Преподаватель. 
